const ContactBanner = () => {
    return (
        <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 text-[#21304E]">
            <div className="flex flex-col justify-between">
                <div className="space-y-2">
                    <h2 className="text-4xl  text-[#21304E] font-bold leadi lg:text-5xl">Book a Demo</h2>
                    <div className="text-[#21304E]">We will show you how it can help business</div>
                </div>
